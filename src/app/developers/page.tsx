                        ...
                        <section>
                            ...
                            <div className="bg-[#0a0a0a] border border-gray-800 p-6 rounded-sm">
                                <p className="text-gray-300 mb-6 leading-relaxed">
                                    Shai-Hulud 2.0 is designed to run in two distinct modes,
                        ...
                        <section className="bg-[#0a0a0a] border border-gray-800 p-6 rounded-sm">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center justify-between border-b border-gray-800 pb-2">
                                    ...
                                    <span className="text-white font-mono text-sm">Next.js 15</span>
                                </div>
                                <div className="flex items-center justify-between border-b border-gray-800 pb-2">
                                    <span className="text-gray-400 text-sm">Database</span>
                                    <span className="text-white font-mono text-sm">SQLite + Vector</span>
                                </div>
                                <div className="flex items-center justify-between border-b border-gray-800 pb-2">
                                    <span className="text-gray-400 text-sm">Styling</span>
                                    <span className="text-white font-mono text-sm">Tailwind CSS</span>
                                </div>
                                <div className="flex items-center justify-between border-b border-gray-800 pb-2">
                                    <span className="text-gray-400 text-sm">Pipeline</span>
                                    <span className="text-white font-mono text-sm">Dagger (Go)</span>
                                </div>
                                <div className="flex items-center justify-between pb-2">
                                    <span className="text-gray-400 text-sm">AI Model</span>
                                    <span className="text-white font-mono text-sm">Xenova/all-MiniLM</span>
                                </div>
                            </div>
                        </section>
                    </div>
